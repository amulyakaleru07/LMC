...
const Myenrollments = () => {
  ...
  // ✅ Make sure progressArray matches enrolledCourses length
  ...
  return (
    ...
    <div className='md:px-36 px-4 pt-10'>
      ...
      <table className='table-auto border-separate border-spacing-y-4 w-full overflow-hidden border mt-10'>
